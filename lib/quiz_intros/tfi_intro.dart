...
//量表结果的历史记录
class tfiIntroPage extends StatefulWidget {
  // String data;
  const tfiIntroPage({super.key}); //, required this.data

  @override
  State<tfiIntroPage> createState() => _tfiIntroPageState();
}

class _tfiIntroPageState extends State<tfiIntroPage> {
  @override
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage("assets/images/TFIintro.png"),
                ...
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => QuizPage(
                          chosenquiz: StoreQuizs.quizsList[2]))); //传入加载的量表
                },
                child: const Image(
